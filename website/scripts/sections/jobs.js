                ...
                <div className='row'>
                    <div className='col-md-12'>
                        <div className='col-md-8'>
                            Want to find local jobs fast? Then use your local job centre. You can find one in the centre of Paisley here. There are also various job centres in Renfrewshire including in Renfrew, Johnston and Barrhead. You may also need to visit the Job Centre to access certain state benefits so make sure you know your local branch.  
                        </div>
                        <br />
